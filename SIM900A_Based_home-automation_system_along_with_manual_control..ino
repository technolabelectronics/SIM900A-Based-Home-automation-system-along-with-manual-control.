...
const int relay3 = 11;  // relay3 connected to pin 12
const int relay4 = 1;  // relay4 connected to pin 11

#define switch1 5      // switch1 connected to pin 4
#define switch2 4      // switch1 connected to pin 5
#define switch3 3      // switch1 connected to pin 4
#define switch4 2      // switch1 connected to pin 5
